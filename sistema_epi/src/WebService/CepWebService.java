        ...
        try {
            ...
            for (Iterator i = ((org.dom4j.Element) root).elementIterator(); i.hasNext();) {
                ...
                if (((org.dom4j.Element) element).getQualifiedName().equals("uf"))
                    setEstado(((Node) element).getText());
