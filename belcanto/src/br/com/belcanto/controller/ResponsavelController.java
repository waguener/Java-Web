...
public class ResponsavelController implements Serializable {
	...
	public String salvarResp() {
		...
		FacesMessage msm = new FacesMessage("Responsável salvo com sucesso!!");
	...
	public String salvarEdit() {
		...
		FacesMessage msm = new FacesMessage("Responsável Editado com Sucesso!!");
		FacesContext.getCurrentInstance().addMessage(null, msm);
		FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
	...
	public void porNome() {
		...
		if(listarNomes.isEmpty()) {
			...
			FacesContext.getCurrentInstance().addMessage(null,
			new FacesMessage(FacesMessage.SEVERITY_ERROR, "Nenhum Encontrado!", "Informação"));
		}
	}
	...
	public void alunos(Responsavel responsavel) {
		...
		if(alunos.isEmpty()) {
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_ERROR, "Nenhum Aluno Encontrado!", "Informação"));
		}else {
			RequestContext context = RequestContext.getCurrentInstance();
